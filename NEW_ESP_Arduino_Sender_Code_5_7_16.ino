  ...
  if (receiver.available())
  {
   ...
   //   Serial.print("String2found");
    ...
    //  Serial.print(F1);
      if (F1 == '0')
      {
        Serial.println("F1 is LOW");
        EEPROM.write(2, LOW);
      }
      if (F1 == '1')
      {
        Serial.println("F1 is HIGH");
        EEPROM.write(2, HIGH);
      }
    }
    ...
    {
   //   Serial.print("String4found");
      while (!receiver.available());
   //   Serial.print("available");
      char Fs = receiver.read();
   //   Serial.print(Fs);
    Serial.print("Fan Speed is found=");
  Serial.println(Fs);
      if (Fs == '0' )
      {
   //     Serial.print("String found");
